...
>{warning.fa fa-laptop} `.env` ফাইল এবং পরিবেশ ভিত্তিক কনফিগারেশন সম্পর্কে আরও তথ্যের জন্য, সম্পূর্ণ [কনফিগারেশন ডকুমেন্টেশন](https://laravel.com/docs/9.x/configuration#environment-configuration) দেখুন।
