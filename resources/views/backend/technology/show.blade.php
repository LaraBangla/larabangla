...
<section>
    <div class="container mx-auto bg-gray-100 rounded-lg mt-10 pb-10 ">
        ...
        <a href="{{ route('admin.all.technologies') }}" class=" float-right mr-3 bg-gray-300 p-3 rounded-md font-normal hover:bg-gray-400">All Technologies</a>
        <div class="p-5">
        ...
        <div class=" border-t">
            <h3 class=" font-bold text-xl ml-5">Versions</h3>
        <a href="{{ route('admin.add.version', Crypt::encryptString($find->id)) }}" class=" float-right mr-3 bg-gray-300 p-3 rounded-md font-normal hover:bg-gray-400">Add Version</a>
