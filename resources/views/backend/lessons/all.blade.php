        ...
        <table class="border-separate border-spacing-2 border border-slate-400 w-full">
            <thead>
              <tr>
                ...
                <th class="border border-slate-300 bg-gray-300">Technology</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="border border-slate-300 p-2">{{ $row->technology->name }}</td>
                <td class="border border-slate-300 p-2 w-28">
                    {{-- <a href="#" class="p-2 text-lg bg-sky-400 mx-1 rounded-sm"><i class="fa-solid fa-eye"></i></a> --}}
                    <a href="{{ route('admin.edit.version',$row->id) }}" class="p-2 text-lg bg-green-700 text-white mx-1 rounded-sm"><i class="fa-solid fa-pen-to-square"></i></a>
                    <a href="{{ route('admin.delete.version',Crypt::encryptString($row->id)) }}" onclick="return confirm('Are you sure?')" class="p-2 text-lg bg-red-700 text-white mx-1 rounded-sm"><i class="fa-solid fa-trash"></i></a>
