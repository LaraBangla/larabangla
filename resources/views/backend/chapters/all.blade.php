        ...
        @foreach ($data as $key => $row)
          <tr>
            ...
            <td class="w-28 border border-slate-300 p-2">
              ...
              <a class="mx-1 rounded-sm bg-green-700 p-2 text-lg text-white" href="{{ route('admin.edit.version', $row->id) }}"><i
                   class="fa-solid fa-pen-to-square"></i></a>
              <a class="mx-1 rounded-sm bg-red-700 p-2 text-lg text-white" href="{{ route('admin.delete.version', Crypt::encryptString($row->id)) }}"
