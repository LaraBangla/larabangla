...
<body class=" bg-gray-50">
    ...
    >
        <div class="flex">
            <div class=" w-60 h-screen bg-slate-200 border-r border-gray-300 duration-500" x-show="sidebar" x-transition>
                <div class="text-center pt-6 pb-6 border-b border-gray-300">
                    <a class=" text-gray-600 text-xl font-bold" href="#">Dashboard</a>
                </div>
            </div>
            <div class=" w-screen">
                <div class="py-4 bg-gray-200">
                    <ul class="flex justify-end">
                        ...
                        <li class="px-3 py-1 mr-2"><img class=" rounded-full w-8 ring-2" src="https://ui-avatars.com/api/?name=Anowar+Hosen&background=0000&color=fff" alt=""></li>
                    </ul>
                </div>
            </div>
        </div>
