                                ...
                                <div class="mt-6 mx-auto">
                                    ...
                                    <div class="flex justify-center">
                                        <div class="flex justify-center mr-3">
                                            <a href="#" type="button" data-mdb-ripple="true" data-mdb-ripple-color="light" class="inline-block p-4 mb-2 bg-gray-100 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-lg hover:shadow-xl focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out" >
                                        ...
                                        <div class="flex justify-center mr-3">
                                            <a href="#" data-mdb-ripple="true" data-mdb-ripple-color="light" class="inline-block p-4 mb-2 bg-gray-100 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-lg hover:shadow-xl focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out" >
